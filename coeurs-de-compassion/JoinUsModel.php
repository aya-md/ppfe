...
class volenteer {
    ...
    private $Phone;
    private $Gender;
    private $Photo;// is it booleen?
    private $Academiclvl;
    private $Speciality;
    private $Intrests;
    private $Activities; 
    private $Objectives;
    public function volonteer ($FullName='',$Cin='',$Date='',$BirthPlace='',$Email='',$Phone='',$Gender='',$Photo='',$Academiclvl='',$Speciality='',$Intrests='',$Activities='',$Objectives=''){
    ...
    public function create(){
        $v = connexion::connexionbd()->prepare("insert into volenteer(FullName,Cin,Date,BirthPlace,Email,Phone,Gender,Photo,Academiclvl,Speciality,Intrests,Activities,Objectives) values(?,?,?,?,?,?,?,?,?,?,?,?,?);");
        $v->bindParam(1,$this->FullName);
        $v->bindParam(2,$this->Cin);
        $v->bindParam(3,$this->Date);
        $v->bindParam(4,$this->BirthPlace);
        $v->bindParam(5,$this->Email);
        $v->bindParam(6,$this->Phone);
        $v->bindParam(7,$this->Gender);
        $v->bindParam(8,$this->Photo);
        $v->bindParam(9,$this->Academiclvl);
        $v->bindParam(10,$this->Speciality);
        $v->bindParam(11,$this->Intrests);
        $v->bindParam(12,$this->Activities);
        $v->bindParam(13,$this->Objectives);
