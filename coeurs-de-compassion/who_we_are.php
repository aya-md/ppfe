<?php include 'include/header.php';?>
        ...
        <div class="about-style-2">
            <div class="container cnt">
                <div class="row ">
                    <div class="col-md-6 col-sm-12 col-12 pp">
                        <div class="about-img">
                           <img src="assets2/images/presidentpic.jpeg" alt=""> 
                    ...
                    <div class="col-md-6 col-sm-12 col-12 ">
                        <div class="about-content ac ">
                            ...
                            <div class="signature">
                                <!--<img class="sign" src="assets2/images/signature.png" alt="">-->
                            </div>
                        </div>
                    </div>
                </div>
...
<!-- aboout us start -->
        ...
        <div class="about-style2" style="width:100%;">
        ...
        <figure class="org-chart cf">
          <ul class="administration"style="margin-left:7rem;">
            <li>					
              <ul class="director" >
                <li>
                  <a href="#"style="background-color: #FCBF49;margin-top: 4.375rem;"><span >President <br> Moustapha AOUNI</span></a>
                  <ul class="subdirector">
                    <li><a href="#" style="background-color: #d4920c;"><span>Vice President <br> Hafida BOUHIJA</span></a></li>
                  </ul>
                  <ul class="departments cf">								
                    ...
                    <li class="department dep-b">
                      <a style="background-color: #fb9e76;"href="#"><span>Tresorier <br> Ishaq EZZAKRAOUI</span></a>
                      <ul class="sections">
                        <li class="section"><a style="background-color: #fb9e76;"href="#"><span>Vice Tresorier <br> Nawal KAMILI</span></a></li>
                       
                      </ul>
                    </li>
                    <li class="department dep-c">
                      <a style="background-color: #fab181;" href="#"><span >Consultants</span></a>
                      <ul class="sections">
                        <li class="section"><a style="background-color: #fab181;"href="#"><span>Abderazak RZAKI</span></a></li>
                        <li class="section"><a style="background-color: #fab181;"href="#"><span>Nawal ELFADILI</span></a></li>
                        <li class="section"><a style="background-color: #fab181;"href="#"><span>ZAHRA RHALI</span></a></li>
